...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    function initializeGame() {
        game = new (0, _gameClassJsDefault.default)();
...
},{"../modules/Game.class.js":"eIbh2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eIbh2":[function(require,module,exports,__globalThis) {
'use strict';
/**
   ...
   */ createEmptyBoard() {
    ...
    moveLeft() {
        ...
        for(let row = 0; row < 4; row++){
            ...
            if (JSON.stringify(mergedRow) !== JSON.stringify(this.board[row])) moved = true;
    ...
    checkGameOver() {
        let gameOver = true;
        for(let r = 0; r < 4; r++)for(let c = 0; c < 4; c++){
            if (this.board[r][c] === 0) gameOver = false;
            if (r < 3 && this.board[r][c] === this.board[r + 1][c]) gameOver = false;
            if (c < 3 && this.board[r][c] === this.board[r][c + 1]) gameOver = false;
        }
        if (gameOver) this.status = 'lose';
        for(let r = 0; r < 4; r++){
            for(let c = 0; c < 4; c++)if (this.board[r][c] === 2048) this.status = 'win';
        }
    }
    /**
